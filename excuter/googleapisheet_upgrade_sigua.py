...
####投注資料
ttt_count123 = session_requests.get("https://sg.88lard.com/api/v1/stats/vendors/game_report?start_at="+ddd+"T00%3A00%3A00-04%3A00&end_at="+ddd+"T23%3A59%3A59-04%3A00&to_CNY=true" , headers=headers )
...
ttt_count = session_requests.get("https://sg.88lard.com/api/v1/stats/agents/wager_report?canceled=0&start_at="+ddd+"T00%3A00%3A00-04%3A00&end_at="+ddd+"T23%3A59%3A59-04%3A00&timeOption=at&currency=&to_CNY=true&specify=0&=&vendor=bbin&vendor=sp&vendor=boe&vendor=crown&vendor=nbb_sport&vendor=ae&vendor=im&kind=1&kind=1&kind=1&kind=1&kind=1&kind=1&kind=1&parentOption=all&first_result=0&max_results=30" , headers=headers )
...
ttt_count = session_requests.get("https://sg.88lard.com/api/v1/stats/agents/wager_report?canceled=0&start_at="+ddd+"T00%3A00%3A00-04%3A00&end_at="+ddd+"T23%3A59%3A59-04%3A00&timeOption=at&currency=&to_CNY=true&specify=0&=&vendor=ky&vendor=fg&vendor=jdb_card&vendor=mt&vendor=lg_card&vendor=th&vendor=leg&vendor=lg_yb_card&kind=5&kind=5&kind=5&kind=5&kind=5&kind=5&kind=5&kind=5&parentOption=all&first_result=0&max_results=30" , headers=headers )
wager_data=ttt_count.json()['total']
wager_data=pd.DataFrame([wager_data])[['user_count']]
wager_data['kind']=5
wager_dataall=wager_dataall.append(wager_data)

ttt_count = session_requests.get("https://sg.88lard.com/api/v1/stats/agents/wager_report?canceled=0&start_at="+ddd+"T00%3A00%3A00-04%3A00&end_at="+ddd+"T23%3A59%3A59-04%3A00&timeOption=at&currency=&to_CNY=true&specify=0&=&vendor=xbb_mj&kind=6&parentOption=all&first_result=0&max_results=30" , headers=headers )
wager_data=ttt_count.json()['total']
wager_data=pd.DataFrame([wager_data])[['user_count']]
wager_data['kind']=6
wager_dataall=wager_dataall.append(wager_data)
...
####註冊會員數
ttt_count = session_requests.get("https://sg.88lard.com/api/v1/player/daily_register?created_day="+ddd+"&first_result=0&max_results=20" , headers=headers )
countnewuser=int(ttt_count.json()['pagination']['total'])
new_register_user=[]
for i in range(0, countnewuser, 1000) :   
    ttt_new = session_requests.get("https://sg.88lard.com/api/v1/player/daily_register?created_day="+ddd+"&first_result="+str(i)+"&max_results=1000" , headers=headers )
...
#'------------------------手机支付' 手機支付 
cdata22_s=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('测试')) & (register_deposite_3["存入状态"] == True) & ((register_deposite_3["支付类型"] == "手机支付") | (register_deposite_3["支付类型"] == "手機支付")) ]
cdata22_f=register_deposite_3d[(~register_deposite_3d['会员层级'].str.contains('测试')) & ((register_deposite_3d["存入状态"] == False) & (register_deposite_3d["存入情況"] == False)) & ((register_deposite_3d["支付类型"] == "手机支付") | (register_deposite_3d["支付类型"] == "手機支付")) ]
...
#'------------------------在线支付' 在線支付
cdata22_s=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('测试')) & (register_deposite_3["存入状态"] == True) & ((register_deposite_3["支付类型"] == "在线支付")|(register_deposite_3["支付类型"] == "在線支付")) & (register_deposite_3["第三方平台"] != "JJ代客充值")]
cdata22_f=register_deposite_3d[(~register_deposite_3d['会员层级'].str.contains('测试')) & ((register_deposite_3d["存入状态"] == False) & (register_deposite_3d["存入情況"] == False)) & ((register_deposite_3d["支付类型"] == "在线支付")|(register_deposite_3d["支付类型"] == "在線支付")) & (register_deposite_3d["第三方平台"] != "JJ代客充值")]
unique_user_s=cdata22_s['会员帐号'] 
unique_user_f=cdata22_f['会员帐号']
unique_amount_s=cdata22_s['申请金额']
unique_amount_f=cdata22_f['申请金额']
...
#'------------------------扫码支付' 掃碼支付
cdata22_s=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('测试')) & (register_deposite_3["存入状态"] == True) & ((register_deposite_3["支付类型"] == "扫码支付")|(register_deposite_3["支付类型"] == "掃碼支付"))]
cdata22_f=register_deposite_3d[(~register_deposite_3d['会员层级'].str.contains('测试')) & ((register_deposite_3d["存入状态"] == False) & (register_deposite_3d["存入情況"] == False)) & ((register_deposite_3d["支付类型"] == "扫码支付")|(register_deposite_3d["支付类型"] == "掃碼支付"))]
unique_user_s=cdata22_s['会员帐号']
unique_user_f=cdata22_f['会员帐号']
unique_amount_s=cdata22_s['申请金额']
unique_amount_f=cdata22_f['申请金额']
...
#'------------------------公司入款'
cdata11_s=register_deposite_c[(~register_deposite_c['会员层级'].str.contains('测试')) & (register_deposite_c["存入状态"] == True)]
cdata11_f=register_deposite_c[(~register_deposite_c['会员层级'].str.contains('测试')) & ((register_deposite_c["存入状态"] == False) & (register_deposite_c["存入情況"] == True))]
...
#'------------------------电子钱包入款'
cdata33_s=register_deposite_e[(~register_deposite_e['会员层级'].str.contains('测试')) & (register_deposite_e["存入状态"] == True)]
cdata33_f=register_deposite_ed[(~register_deposite_ed['会员层级'].str.contains('测试')) & ((register_deposite_ed["存入状态"] == False) & (register_deposite_ed["存入情況"] == False))]
...
#'------------------------加密货币入款'
cdata44_s=register_deposite_m[(~register_deposite_m['会员层级'].str.contains('测试')) & (register_deposite_m["存入状态"] == True)]
cdata44_f=register_deposite_md[(~register_deposite_md['会员层级'].str.contains('测试')) & ((register_deposite_md["存入状态"] == False) & (register_deposite_md["存入情況"] == False))]
...
#公司 # 
cdata222_s=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('测试')) & (register_deposite_3["存入状态"] == True )]
cdata222_f=register_deposite_3d[(~register_deposite_3d['会员层级'].str.contains('测试')) & ((register_deposite_3d["存入状态"] == False) & (register_deposite_3d["存入情況"] == False)) & (register_deposite_3d["第三方平台"] != "JJ代客充值")]
cdata111_s=register_deposite_c[(~register_deposite_c['会员层级'].str.contains('测试')) & (register_deposite_c["存入状态"] == True)]
cdata111_f=register_deposite_c[(~register_deposite_c['会员层级'].str.contains('测试')) & ((register_deposite_c["存入状态"] == False) & (register_deposite_c["存入情況"] == True))]
cdata333_s=register_deposite_e[(~register_deposite_e['会员层级'].str.contains('测试')) & (register_deposite_e["存入状态"] == True)]
cdata333_f=register_deposite_ed[(~register_deposite_ed['会员层级'].str.contains('测试')) & ((register_deposite_ed["存入状态"] == False) & (register_deposite_ed["存入情況"] == False))]
cdata444_s=register_deposite_m[(~register_deposite_m['会员层级'].str.contains('测试')) & (register_deposite_m["存入状态"] == True)]
cdata444_f=register_deposite_md[(~register_deposite_md['会员层级'].str.contains('测试')) & ((register_deposite_md["存入状态"] == False) & (register_deposite_md["存入情況"] == False))]
...
for k in range(0,15000,1000): 
    ttt = session_requests.get("https://sg.88lard.com/api/v1/player/list?level=797&first_result="+str(k)+"&max_results=1000&fields=enable&fields=username" , headers=headers )
    output_data=ttt.json()['ret']
...
#首次充值人数
#公司
new_user_c=register_deposite_c[(~register_deposite_c['会员层级'].str.contains('测试')) & (register_deposite_c["首存"] == True)]
count_user1=new_user_c.shape[0]
sum_price1=sum(new_user_c['申请金额'])
#第三方
new_user_3=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('测试')) & (register_deposite_3["首存"] == True) ]
count_user2=new_user_3.shape[0]
sum_price2=sum(new_user_3['申请金额'])
#電子錢包
new_user_e=register_deposite_e[(~register_deposite_e['会员层级'].str.contains('测试')) & (register_deposite_e["首存"] == True)]
count_user3=new_user_e.shape[0]
sum_price3=sum(new_user_e['申请金额'])
#加密貨幣
new_user_m=register_deposite_m[(~register_deposite_m['会员层级'].str.contains('测试')) & (register_deposite_m["首存"] == True)]
...
#代客充值系統首次充值人數
new_user_help=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('测试')) & (register_deposite_3["首存"] == True) & (register_deposite_3["第三方平台"] == "JJ代客充值")] 
...
new_user_33=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('测试')) & (register_deposite_3["首存"] == True) & (register_deposite_3["第三方平台"] != "JJ代客充值")]
...
#当日充值总人数
now_deposite1=register_deposite_c[(~register_deposite_c['会员层级'].str.contains('测试')) & (register_deposite_c["存入状态"] == True)]
now_deposite2=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('测试')) & (register_deposite_3["存入状态"] == True)]
now_deposite3=register_deposite_e[(~register_deposite_e['会员层级'].str.contains('测试')) & (register_deposite_e["存入状态"] == True)]
now_deposite4=register_deposite_m[(~register_deposite_m['会员层级'].str.contains('测试')) & (register_deposite_m["存入状态"] == True)]
...
#有效投注总人数
#count_p_b=len(np.unique(betamount_count_p[(betamount_count_p['会员层级'] != '测试帳號')]['会员帐号']))  
...
#'安卓系统充值成功率(数据群)',
cdata11_s_platform=register_deposite_c[(~register_deposite_c['会员层级'].str.contains('测试')) & (register_deposite_c["存入状态"] == True)] 
cdata11_f_platform=register_deposite_c[(~register_deposite_c['会员层级'].str.contains('测试')) & ((register_deposite_c["存入状态"] == False) & (register_deposite_c["存入情況"] == True))]

cdata22_s_platform=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('测试')) & (register_deposite_3["存入状态"] == True) & (register_deposite_3["第三方平台"] != 'JJ代客充值')]
cdata22_f_platform=register_deposite_3d[(~register_deposite_3d['会员层级'].str.contains('测试')) & ((register_deposite_3d["存入状态"] == False) & (register_deposite_3d["存入情況"] == False)) & (register_deposite_3d["第三方平台"] != "JJ代客充值")]

cdata33_s_platform=register_deposite_e[(~register_deposite_e['会员层级'].str.contains('测试')) & (register_deposite_e["存入状态"] == True)]
cdata33_f_platform=register_deposite_ed[(~register_deposite_ed['会员层级'].str.contains('测试')) & ((register_deposite_ed["存入状态"] == False) & (register_deposite_ed["存入情況"] == False))]

cdata44_s_platform=register_deposite_m[(~register_deposite_m['会员层级'].str.contains('测试')) & (register_deposite_m["存入状态"] == True)]
cdata44_f_platform=register_deposite_md[(~register_deposite_md['会员层级'].str.contains('测试')) & ((register_deposite_md["存入状态"] == False) & (register_deposite_md["存入情況"] == False))]
...
#'成功最大一笔多少钱(数据组
cdata22_s_platform_max=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('测试')) & (register_deposite_3["存入状态"] == True)]
cdata22_f_platform_max=register_deposite_3d[(~register_deposite_3d['会员层级'].str.contains('测试')) & ((register_deposite_3d["存入状态"] == False) & (register_deposite_3d["存入情況"] == False))]
...
SAMPLE_SPREADSHEET_ID = '1hbZKRNn4utuJq9uHoYsCrzDYU3j2hAvMdZ0LCi9uoZI'
