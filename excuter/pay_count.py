...
#open csv file  
#註冊會員數
register_user = pd.read_csv("F:/Desktop/download_csv/daily_register.csv", encoding = "utf-8") # header=None skiprows = 1

#成功  審核時間
register_deposite_c = pd.read_csv("F:/Desktop/download_csv/公司入款纪录.csv" , encoding = "utf-8")
register_deposite_3 = pd.read_csv("F:/Desktop/download_csv/第三方入款纪录.csv", encoding = "utf-8")
register_deposite_e = pd.read_csv("F:/Desktop/download_csv/电子钱包入款纪录.csv" , encoding = "utf-8")
register_deposite_m = pd.read_csv("F:/Desktop/download_csv/加密货币入款纪录.csv" , encoding = "utf-8")

#失敗  申請時間
register_deposite_3d = pd.read_csv("F:/Desktop/download_csv/第三方入款纪录(1).csv", encoding = "utf-8")
register_deposite_ed = pd.read_csv("F:/Desktop/download_csv/电子钱包入款纪录(1).csv" , encoding = "utf-8")
register_deposite_md = pd.read_csv("F:/Desktop/download_csv/加密货币入款纪录(1).csv" , encoding = "utf-8")

#檢查存款細項
deposite_user = pd.read_csv("F:/Desktop/download_csv/deposit_invoice_entries.csv", encoding = "utf-8")
withdraw_user = pd.read_csv("F:/Desktop/download_csv/withdraw_entries.csv", encoding = "utf-8")

#VIP客源
vipList = pd.read_csv("F:/Desktop/download_csv/vipList.csv", encoding = "utf-8")
...
#'------------------------手机支付' 手機支付
cdata22_s=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('測試')) & (register_deposite_3["存入状态"] == '="已入帐"') & ((register_deposite_3["支付类型"] == '="手机支付"') | (register_deposite_3["支付类型"] == '="手機支付"')) ]
cdata22_f=register_deposite_3d[(~register_deposite_3d['会员层级'].str.contains('測試')) & (register_deposite_3d["存入状态"] == '="未送单"') & ((register_deposite_3d["支付类型"] == '="手机支付"') | (register_deposite_3d["支付类型"] == '="手機支付"')) ]
...
all_dataframe_data.iloc[4]=round(len(unique_user_s)/(len(unique_user_s)+len(unique_user_f)) * 100 ,2) 
...
#'------------------------在线支付' 在線支付
cdata22_s=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('測試')) & (register_deposite_3["存入状态"] == '="已入帐"') & ((register_deposite_3["支付类型"] == '="在线支付"')|(register_deposite_3["支付类型"] == '="在線支付"')) & (register_deposite_3["后台代称"] != '="代客充值-鸭脖银行卡支援"')]
cdata22_f=register_deposite_3d[(~register_deposite_3d['会员层级'].str.contains('測試')) & (register_deposite_3d["存入状态"] == '="未送单"') & ((register_deposite_3d["支付类型"] == '="在线支付"')|(register_deposite_3d["支付类型"] == '="在線支付"')) & (register_deposite_3d["第三方平台"] != '="JJ代客充值"')]
unique_user_s=cdata22_s['会员帐号']
unique_user_f=cdata22_f['会员帐号']
unique_amount_s=cdata22_s['申请金额']
unique_amount_f=cdata22_f['申请金额']
...
all_dataframe_data.iloc[9]=round(len(unique_user_s)/(len(unique_user_s)+len(unique_user_f)) * 100 ,2)
...
#'------------------------扫码支付' 掃碼支付
cdata22_s=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('測試')) & (register_deposite_3["存入状态"] == '="已入帐"') & ((register_deposite_3["支付类型"] == '="扫码支付"')|(register_deposite_3["支付类型"] == '="掃碼支付"'))]
cdata22_f=register_deposite_3d[(~register_deposite_3d['会员层级'].str.contains('測試')) & (register_deposite_3d["存入状态"] == '="未送单"') & ((register_deposite_3d["支付类型"] == '="扫码支付"')|(register_deposite_3d["支付类型"] == '="掃碼支付"'))]
unique_user_s=cdata22_s['会员帐号']
unique_user_f=cdata22_f['会员帐号']
unique_amount_s=cdata22_s['申请金额']
unique_amount_f=cdata22_f['申请金额']
...
all_dataframe_data.iloc[14]=round(len(unique_user_s)/(len(unique_user_s)+len(unique_user_f)) * 100 ,2)
...
#'------------------------公司入款'
cdata11_s=register_deposite_c[(register_deposite_c['会员层级'] != '="測試帳號"') & (register_deposite_c["存入状态"] == '="已入帐"')]
cdata11_f=register_deposite_c[(register_deposite_c['会员层级'] != '="測試帳號"') & (register_deposite_c["存入状态"] != '="已入帐"')]
...
all_dataframe_data.iloc[19]=round(len(unique_user_s)/(len(unique_user_s)+len(unique_user_f)) * 100 ,2)
...
#'------------------------代客充值'
cdata22_s=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('測試')) & (register_deposite_3["存入状态"] == '="已入帐"') & ((register_deposite_3["支付类型"] == '="在线支付"')|(register_deposite_3["支付类型"] == '="在線支付"')) & (register_deposite_3["第三方平台"] == '="JJ代客充值"')]
unique_user_s=cdata22_s['会员帐号']
unique_amount_s=cdata22_s['申请金额']
...
#'------------------------电子钱包入款'
cdata33_s=register_deposite_e[(register_deposite_e['会员层级'] != '="測試帳號"') & (register_deposite_e["存入状态"] == '="已入帐"')]
cdata33_f=register_deposite_ed[(register_deposite_ed['会员层级'] != '="測試帳號"') & (register_deposite_ed["存入状态"] != '="已入帐"')]
...
all_dataframe_data.iloc[28]=round(len(unique_user_s)/(len(unique_user_s)+len(unique_user_f)) * 100 ,2)
...
#'------------------------加密货币入款'
cdata44_s=register_deposite_m[(register_deposite_m['会员层级'] != '="測試帳號"') & (register_deposite_m["存入状态"] == '="已入帐"')]
cdata44_f=register_deposite_md[(register_deposite_md['会员层级'] != '="測試帳號"') & (register_deposite_md["存入状态"] != '="已入帐"')]
...
#公司 #
cdata222_s=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('測試')) & (register_deposite_3["存入状态"] == '="已入帐"' )]
cdata222_f=register_deposite_3d[(~register_deposite_3d['会员层级'].str.contains('測試')) & (register_deposite_3d["存入状态"] == '="未送单"') & (register_deposite_3d["第三方平台"] != '="JJ代客充值"')]
cdata111_s=register_deposite_c[(~register_deposite_c['会员层级'].str.contains('測試')) & (register_deposite_c["存入状态"] == '="已入帐"')]
cdata111_f=register_deposite_c[(~register_deposite_c['会员层级'].str.contains('測試')) & (register_deposite_c["存入状态"] != '="已入帐"')]
cdata333_s=register_deposite_e[(~register_deposite_e['会员层级'].str.contains('測試')) & (register_deposite_e["存入状态"] == '="已入帐"')]
cdata333_f=register_deposite_ed[(~register_deposite_ed['会员层级'].str.contains('測試')) & (register_deposite_ed["存入状态"] != '="已入帐"')]
cdata444_s=register_deposite_m[(~register_deposite_m['会员层级'].str.contains('測試')) & (register_deposite_m["存入状态"] == '="已入帐"')]
cdata444_f=register_deposite_md[(~register_deposite_md['会员层级'].str.contains('測試')) & (register_deposite_md["存入状态"] != '="已入帐"')]
...
#首次充值人数
#公司
new_user_c=register_deposite_c[(~register_deposite_c['会员层级'].str.contains('測試')) & (register_deposite_c["首存"] == '="Y"')]
count_user1=new_user_c.shape[0]
sum_price1=sum(new_user_c['申请金额'])
#第三方
new_user_3=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('測試')) & (register_deposite_3["首存"] == '="Y"') & (register_deposite_3["第三方平台"] != '="JJ代客充值"')]
count_user2=new_user_3.shape[0]
sum_price2=sum(new_user_3['申请金额'])
#電子錢包
new_user_e=register_deposite_e[(~register_deposite_e['会员层级'].str.contains('測試')) & (register_deposite_e["首存"] == '="Y"')]
count_user3=new_user_e.shape[0]
sum_price3=sum(new_user_e['申请金额'])
#加密貨幣
new_user_m=register_deposite_m[(~register_deposite_m['会员层级'].str.contains('測試')) & (register_deposite_m["首存"] == '="Y"')]
...
and_user=new_user_c['操作端'].append(new_user_3['操作端']).append(new_user_e['操作端'])
...
#当日充值总人数
now_deposite1=register_deposite_c[(~register_deposite_c['会员层级'].str.contains('測試')) & (register_deposite_c["存入状态"] == '="已入帐"')]
now_deposite2=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('測試')) & (register_deposite_3["存入状态"] == '="已入帐"')]
now_deposite3=register_deposite_e[(~register_deposite_e['会员层级'].str.contains('測試')) & (register_deposite_e["存入状态"] == '="已入帐"')]
now_deposite4=register_deposite_m[(~register_deposite_m['会员层级'].str.contains('測試')) & (register_deposite_m["存入状态"] == '="已入帐"')]
...
#'安卓系统充值成功率(数据群)',
cdata11_s_platform=register_deposite_c[(~register_deposite_c['会员层级'].str.contains('測試')) & (register_deposite_c["存入状态"] == '="已入帐"')]
cdata11_f_platform=register_deposite_c[(~register_deposite_c['会员层级'].str.contains('測試')) & (register_deposite_c["存入状态"] == '="已取消"')]

cdata22_s_platform=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('測試')) & (register_deposite_3["存入状态"] == '="已入帐"') & (register_deposite_3["第三方平台"] != '="JJ代客充值"')]
cdata22_f_platform=register_deposite_3d[(~register_deposite_3d['会员层级'].str.contains('測試')) & (register_deposite_3d["存入状态"] == '="未送单"') & (register_deposite_3d["第三方平台"] != '="JJ代客充值"')]

cdata33_s_platform=register_deposite_e[(~register_deposite_e['会员层级'].str.contains('測試')) & (register_deposite_e["存入状态"] == '="已入帐"')]
cdata33_f_platform=register_deposite_ed[(~register_deposite_ed['会员层级'].str.contains('測試')) & (register_deposite_ed["存入状态"] == '="未送单"')]

cdata44_s_platform=register_deposite_m[(~register_deposite_m['会员层级'].str.contains('測試')) & (register_deposite_m["存入状态"] == '="已入帐"')]
cdata44_f_platform=register_deposite_md[(~register_deposite_md['会员层级'].str.contains('測試')) & (register_deposite_md["存入状态"] == '="未送单"')]
...
#'成功最大一笔多少钱(数据组
cdata22_s_platform_max=register_deposite_3[(~register_deposite_3['会员层级'].str.contains('測試')) & (register_deposite_3["存入状态"] == '="已入帐"')]
cdata22_f_platform_max=register_deposite_3d[(~register_deposite_3d['会员层级'].str.contains('測試')) & (register_deposite_3d["存入状态"] == '="未送单"')]
...
deposite_user_data=pd.merge(pd.DataFrame(np.unique(register_user['会员帐号']), columns=["会员帐号"] ) ,deposite_cg,on = '会员帐号',how = 'left')
...
#########  今日所有會員存提差   ########   今日創建帳號今日出入款 入款扣除轉讓充值
deposite_user=deposite_user[ (deposite_user['状态']=='通过')]
deposite_cg=pd.DataFrame(deposite_user[deposite_user['存款方式']=='CGPay'].groupby(by=['会员帐号'])['申请金额'].sum()).reset_index().rename(columns={ "申请金额": "CGPay"})
deposite_usdt=pd.DataFrame(deposite_user[deposite_user['存款方式']=='USDT(ERC20)'].groupby(by=['会员帐号'])['申请金额'].sum()).reset_index().rename(columns={ "申请金额": "USDT"})
deposite_company=pd.DataFrame(deposite_user[deposite_user['存款方式']=='公司入款'].groupby(by=['会员帐号'])['申请金额'].sum()).reset_index().rename(columns={ "申请金额": "公司入款"})
...
################## 小額充值問題 #############
#50小額
deposite_50_s=register_deposite_3[(register_deposite_3['会员层级'] != '="測試帳號"') & (register_deposite_3["存入状态"] == '="已入帐"') & (register_deposite_3["申请金额"] == 50)][['会员帐号','后台代称','申请金额']]
deposite_50_f=register_deposite_3d[(register_deposite_3d['会员层级'] != '="測試帳號"') & (register_deposite_3d["存入状态"] == '="未送单"') & (register_deposite_3d["申请金额"] == 50) ][['会员帐号','后台代称','申请金额']]
...
#100大額
deposite_100_s=register_deposite_3[(register_deposite_3['会员层级'] != '="測試帳號"') & (register_deposite_3["存入状态"] == '="已入帐"') & (register_deposite_3["申请金额"] == 100)][['会员帐号','后台代称','申请金额']]
deposite_100_f=register_deposite_3d[(register_deposite_3d['会员层级'] != '="測試帳號"') & (register_deposite_3d["存入状态"] == '="未送单"') & (register_deposite_3d["申请金额"] == 100) ][['会员帐号','后台代称','申请金额']]
...
#存入相同excel中不同sheet
auto_data = pd.ExcelWriter("F:/Desktop/download_csv/auto_data.xlsx")
#美日數據
dataframe_count.to_excel(auto_data, sheet_name="數據-1")
pay_dataframe_data.to_excel(auto_data, sheet_name="金額區間-支付方式")
all_dataframe_data.to_excel(auto_data, sheet_name="各支付方式統計")
#異常
test_different_seposite.to_excel(auto_data, sheet_name="各支付成功失敗")
final_user_n_d_w.to_excel(auto_data, sheet_name="今日註冊會員存提差")
today_alluser_dw.to_excel(auto_data, sheet_name="會員存提差")
hour_table_count_all.to_excel(auto_data, sheet_name="每小時存款細項")
data_small_pay.to_excel(auto_data, sheet_name="小額充值管道成功失敗")
auto_data.save()

import win32com.client as win32_client
excel_application = win32_client.gencache.EnsureDispatch('Excel.Application')
workbook = excel_application.Workbooks.Open("F:/Desktop/download_csv/auto_data.xlsx")

worksheet = workbook.Worksheets("數據-1")
worksheet.Columns.AutoFit()
worksheet = workbook.Worksheets("金額區間-支付方式")
worksheet.Columns.AutoFit()
worksheet = workbook.Worksheets("各支付方式統計")
worksheet.Columns.AutoFit()

worksheet = workbook.Worksheets("各支付成功失敗")
worksheet.Columns.AutoFit()
worksheet = workbook.Worksheets("今日註冊會員存提差")
worksheet.Columns.AutoFit()
worksheet = workbook.Worksheets("會員存提差")
worksheet.Columns.AutoFit()
worksheet = workbook.Worksheets("每小時存款細項")
worksheet.Columns.AutoFit()
worksheet = workbook.Worksheets("小額充值管道成功失敗")
worksheet.Columns.AutoFit()
workbook.Save()
...
#傳送資料
send_telegrame_file("F:/Desktop/download_csv/auto_data.xlsx",str(delay_oneday)+'-數據總攬(每日數據、異常數據)')
