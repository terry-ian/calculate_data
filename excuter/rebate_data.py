...
with pd.ExcelWriter("C:/Users/btorin/Desktop/download_csv_sigua_copy/rebate_data.xlsx") as rebate_data:
...
#傳送資料
send_telegrame_file("C:/Users/btorin/Desktop/download_csv_sigua_copy/rebate_data.xlsx",str(dtd)+'-返利數據')
