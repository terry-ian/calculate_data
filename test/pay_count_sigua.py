...
#open csv file  
#註冊會員數
register_user = pd.read_csv("F:/Desktop/download_csv_sigua/daily_register.csv", encoding = "utf-8") # header=None skiprows = 1

#成功  審核時間
register_deposite_c = pd.read_csv("F:/Desktop/download_csv_sigua/公司入款纪录.csv" , encoding = "utf-8")
register_deposite_3 = pd.read_csv("F:/Desktop/download_csv_sigua/第三方入款纪录.csv", encoding = "utf-8")
register_deposite_e = pd.read_csv("F:/Desktop/download_csv_sigua/电子钱包入款纪录.csv" , encoding = "utf-8")
register_deposite_m = pd.read_csv("F:/Desktop/download_csv_sigua/加密货币入款纪录.csv" , encoding = "utf-8")

#失敗  申請時間
register_deposite_3d = pd.read_csv("F:/Desktop/download_csv_sigua/第三方入款纪录(1).csv", encoding = "utf-8")
register_deposite_ed = pd.read_csv("F:/Desktop/download_csv_sigua/电子钱包入款纪录(1).csv" , encoding = "utf-8")
register_deposite_md = pd.read_csv("F:/Desktop/download_csv_sigua/加密货币入款纪录(1).csv" , encoding = "utf-8")

#檢查存款細項
deposite_user = pd.read_csv("F:/Desktop/download_csv_sigua/deposit_invoice_entries.csv", encoding = "utf-8")
withdraw_user = pd.read_csv("F:/Desktop/download_csv_sigua/withdraw_entries.csv", encoding = "utf-8")

#VIP客源
vipList = pd.read_csv("F:/Desktop/download_csv_sigua/vipList.csv", encoding = "utf-8")
...
with pd.ExcelWriter("F:/Desktop/download_csv_sigua/auto_data_sigua.xlsx") as auto_data_sigua:
    #美日數據
...
#傳送資料
send_telegrame_file("F:/Desktop/download_csv_sigua/auto_data_sigua.xlsx",'SIGUA-'+str(delay_oneday)+'-數據總攬(每日數據、異常數據)')
...
shutil.rmtree('F:\\Desktop\\download_csv_sigua_copy')  
time.sleep(3)
shutil.copytree('F:\\Desktop\\download_csv', 'F:\\Desktop\\download_csv_sigua_copy')  #, symlinks=False, ignore=None
time.sleep(3)
shutil.rmtree('F:\\Desktop\\download_csv_sigua')  
time.sleep(3)
os.mkdir('F:\\Desktop\\download_csv_sigua')     
